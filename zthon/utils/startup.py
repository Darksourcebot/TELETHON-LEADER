    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                "https://graph.org/file/f5b14a926d3d51d8b3e13.jpg",
                
                caption="**•⎆┊تـم بـدء تشغـيل سـورس القائد الخاص بك .. بنجاح 🧸♥️**",
                
                buttons=[(Button.url("𝗦َِ𝗼َِ𝗨َِ𝗿َِ𝗖َِ𝗲 َِ𝗟𝗘𝗮𝗗𝗲𝗥", "https://t.me/SOURCE_LEADER"),)],
...
zthon = {"@SOURCE_LEADER", "@FOR_MONZER", "@M_A_S_E_2", "@Help_Tele_Leader", "@Help_Leader", "@leader_VIAS"}
async def saves():
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        photozed = await zedub.upload_file(file="zedthon/malath/karim.jpg")
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        photozed = await zedub.upload_file(file="zedthon/malath/karim2.jpg")
